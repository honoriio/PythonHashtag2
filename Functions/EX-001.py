...
print(lista_produto(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr))

print(len((lista_produto(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr))))


#Exercicio feito com ajuda do professor, pois estou voltando hoje e não me recordava de como fazer
